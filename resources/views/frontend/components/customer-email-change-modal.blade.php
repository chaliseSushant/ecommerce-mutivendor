<!-- Modal -->
<div class="modal fade" id="change-email" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="col-12 address-form" method="post" action="{{url('/customer/email/change/')}}">
                    @csrf
                    <div class="row">
                        <div class="form-group col-lg-12 col-sm-12">
                            <label for="name">Email</label>
                            <input type="text" name="email" class="form-control form-control-sm" value="{{Auth::user()->email}}" id="email-input">
                        </div>
                        <div class="form-group col-sm-12 button-group">
                            <button type="submit" class="btn btn-warning form-control form-control-sm">Change Email</button>
                        </div>
                    </div>
                </form>
            </div>
