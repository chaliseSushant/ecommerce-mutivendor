<section class="row cart-item-wrap">
    <section class="col-6 cart-item-product">
        <section class="row cart-item-product-row">
            <section class="col-4">
                <img class="img-thumbnail" src="http://multivendor/frontend/images/product.jpg" onerror="this.onerror=null; this.src='http://multivendor/frontend/images/product.jpg'">
            </section>
            <section class="col-8">
