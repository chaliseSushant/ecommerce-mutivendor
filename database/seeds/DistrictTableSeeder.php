...
class DistrictTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ["Parsa",2],["Bara",2],["Rautahat",2],["Sarlahi",2],["Dhanusa",2],["Siraha",2],["Mahottari",2],["Saptari",2],
            ["Sindhuli",3],["Ramechhap",3],["Dolakha",3],["Bhaktapur",3],["Dhading",3],["Kathmandu",3],["Kavrepalanchok",3],["Lalitpur",3],["Nuwakot",3],["Rasuwa",3],["Sindhupalchok",3],["Chitwan",3],["Makwanpur",3],
            ["Baglung",4],["Gorkha",4],["Kaski",4],["Lamjung",4],["Manang",4],["Mustang",4],["Myagdi",4],["Nawalpur",4],["Parbat",4],["Syangja",4],["Tanahun",4],
            ["Kapilvastu",5],["Parasi",5],["Rupandehi",5],["Arghakhanchi",5],["Gulmi",5],["Palp",5],["Dang Deukhuri",5],["Pyuthan",5],["Rolpa",5],["Eastern Rukum",5],["Banke",5],["Bardiya",5],
        ...
        foreach ($data as $datum)
        {
            ...
            $district->province_id = Province::where('code',$datum[1])->first()->id;
            $district->save();
        }
    }
}
